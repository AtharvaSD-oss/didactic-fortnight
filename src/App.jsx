...
export function App() {
  ...
  useEffect(() => {
    const sections = ['home', 'track', 'karts', 'leap-frog', 'whats-new', 'pricing', 'leaderboard', 'gallery', 'contact'];
  ...
  return (
    <div className="min-h-screen bg-[#07070a] text-white selection:bg-[#FF4500] selection:text-white">
