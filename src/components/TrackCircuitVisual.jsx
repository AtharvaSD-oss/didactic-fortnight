...
const TrackCircuitVisual = () => {
  ...
  return (
    <>
      <div className="relative w-full max-w-lg lg:max-w-xl mx-auto rounded-2xl bg-white border-2 border-[#E5E5E5] hover:border-[#F47C20] p-2 sm:p-3 shadow-md hover:shadow-xl transition-all duration-500 overflow-hidden group text-left">
        {/* Track Image Frame */}
        <div className="relative w-full aspect-[1024/819] max-h-[380px] sm:max-h-[420px] rounded-xl overflow-hidden bg-white flex items-center justify-center cursor-pointer" onClick={() => setIsModalOpen(true)}>
          <img
