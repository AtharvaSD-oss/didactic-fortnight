...
const Hero = ({ onOpenBooking, onNavigate }) => {
  ...
  /* Subtle scroll-based parallax on the kart */
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      {/* ════════════════════════════════════════════════════════
          MAIN COMPOSITION: Typography + Overlay Kart
         ════════════════════════════════════════════════════════ */}
      <div className="relative z-10 max-w-[1600px] w-full mx-auto px-5 sm:px-8 lg:px-14 xl:px-20 flex-1 flex flex-col justify-between">
        ...
        {/* LOWER GRID: Left Content & Lower-Right Kart Layer */}
        <div className="relative z-20 grid grid-cols-1 lg:grid-cols-12 items-end pb-8 lg:pb-16 gap-6 lg:gap-0">
          ...
          {/* LOWER-RIGHT: Large Avalanche Kart Visual (Desktop & Tablet) */}
          <div className="hidden lg:block lg:col-span-6 xl:col-span-7 relative self-end -mb-8 xl:-mb-12">
            <motion.div
              ref={kartRef}
            ...
            >
              {/* Natural subtle ground shadow under chassis and tires */}
              <div
                aria-hidden="true"
                className="absolute -bottom-3 left-[12%] right-[5%] h-8 sm:h-12 blur-2xl rounded-full pointer-events-none"
                style={{
                  background:
              ...
              {/* Independent <img> visual layer - 100% synchronized with background via mix-blend-multiply */}
              <img
                src="/avalanche-car-isolated.png"
                alt="Kartomania Avalanche Racing Kart #10"
                width={1000}
                height={600}
                loading="eager"
                fetchPriority="high"
                draggable={false}
                className="
                  w-[60vw] max-w-[1050px] min-w-[550px]
                  xl:w-[62vw] 2xl:w-[65vw]
                  h-auto
                  object-contain
                  mix-blend-multiply
        ...
        {/* MOBILE KART VISUAL: Stacked below CTA cleanly */}
        <div className="block lg:hidden w-full my-4">
          ...
          >
            <div
              aria-hidden="true"
              className="absolute -bottom-2 left-[10%] right-[10%] h-6 blur-xl rounded-full pointer-events-none"
              style={{
                background:
            ...
            <img
              ...
              fetchPriority="high"
              draggable={false}
              className="w-full h-auto object-contain mix-blend-multiply filter contrast-[1.05] brightness-[1.01] select-none pointer-events-none max-w-[540px] mx-auto"
