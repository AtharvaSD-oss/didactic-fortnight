...
const steps = [
  ...
  },
  {
    step: '05',
    title: 'Race',
    desc: 'Grid launch in 270cc Sodi RT10 karts on the 720m outdoor asphalt track.',
    icon: Flag,
    tag: 'HIGH SPEED',
  },
  {
...
const RacingTimeline = () => {
  return (
    <section id="experience-timeline" className="py-20 sm:py-28 px-4 sm:px-6 lg:px-12 bg-white border-t border-[#EAEAEA] relative z-20 text-[#111111]">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-[#E5E5E5] pb-6 text-left">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-[#0A0A0A] text-sm font-bold font-mono">/ RACEDAY JOURNEY</span>
            </div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-sm bg-[#FFF0E5] border border-[#F47C20]/30 font-mono text-xs text-[#F47C20] uppercase tracking-widest font-bold mb-2 shadow-sm">
              <Zap className="w-3.5 h-3.5 text-[#F47C20]" /> // THE RACEDAY JOURNEY
            </div>
            <h2 className="text-3xl sm:text-5xl font-display font-bold text-[#0A0A0A] uppercase tracking-tight">
              YOUR <span className="text-[#F47C20]">RACING EXPERIENCE</span>
            </h2>
          </div>
          <p className="text-xs sm:text-sm font-mono text-[#666666] uppercase tracking-wider max-w-sm">
          ...
          {steps.map((item, idx) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <div className="h-full flex flex-col justify-between space-y-5 p-7 rounded-xl bg-[#F9F9F9] border border-[#E5E5E5] hover:border-[#F47C20] transition-all duration-300 shadow-sm hover:shadow-md text-left group">
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <span className="font-mono text-2xl font-black text-[#F47C20] group-hover:translate-x-1 transition-transform">
                        {item.step}
                      </span>
                      <span className="px-2.5 py-0.5 rounded-sm bg-white text-[#0A0A0A] font-mono text-[9px] font-bold uppercase tracking-wider border border-[#E5E5E5] group-hover:border-[#F47C20]">
                        {item.tag}
                      </span>
                    </div>
