...
const KARTS_DATA = [
  {
    ...
    name: 'SODI RT10 PRO',
    badge: 'MOST POPULAR',
    badgeStyle: 'bg-[#080808] text-white',
  ...
  },
  {
    ...
    badge: 'ROOKIE & YOUTH',
    badgeStyle: 'bg-white text-[#555555] border border-[#CCCCCC]',
              ...
              <div>
                ...
                <div className="p-4 rounded-lg bg-white border border-[#EAEAEA] space-y-2.5 mb-6 font-mono text-xs">
                  ...
                  <div className="flex items-center justify-between border-t border-[#F0F0F0] pt-1">
                    <span className="text-[#888888] font-medium text-[11px]">POWERTRAIN</span>
                    <span className="text-[#333333] font-bold text-[10px] text-right truncate max-w-[130px]">
                      {kart.engine}
                    </span>
                  </div>
                </div>
